...
CREATE TABLE test4(id serial primary key,
                                     name text UNIQUE);
...
CREATE TABLE test6(nuveo serial primary key,
                                        name text, celphone text);
...
CREATE TABLE test_jsonb_bug(id serial NOT NULL,
...
INSERT INTO test_readonly_access (name)
VALUES ('test01');


INSERT INTO test_write_and_delete_access (name)
VALUES ('test01');


INSERT INTO test_list_only_id (name)
VALUES ('test01');


INSERT INTO test_deleteonly_access (name)
VALUES ('test01');


INSERT INTO test_jsonb_bug (name, data)
VALUES('goku',
       '{"techniques": ["kamehameha", "kaioken", "genki-dama"]}');
...
INSERT INTO testarray (id, data)
VALUES(100,
       '{"Gohan","Goten"}');


INSERT INTO test_group_by_table(name, age, salary)
VALUES('joao',
       20,
       1250);
...
INSERT INTO test_group_by_table(name, age, salary)
VALUES('guitarra humana',
       19,
       3998);


INSERT INTO prest_users(username, password)
VALUES('test@postgres.rest',
...
INSERT INTO table_to_view (name, celphone)
VALUES ('gopher',
        '8888888');
