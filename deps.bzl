...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:76t55qLQu3xjMFbkirbSCA8ZPcO1ny+20Uq1wkSTRDE=",
        version = "v1.0.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_gosidekick_migration_v3",
        importpath = "github.com/gosidekick/migration/v3",
        sum = "h1:zebJv3sbP+/TtEOjQbH+QtHkPT/MdtoDk7PebAcFmuQ=",
        version = "v3.0.0",
    )
    go_repository(
